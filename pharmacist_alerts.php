...
if (isset($_GET['resolve'])) {
    ...
    header("Location: pharmacist_alerts.php");
    exit();
}
?>
<!DOCTYPE html>
...
<div class="sidebar" id="sidebar">
    ...
    <a href="pharmacist_alerts.php" class="nav-item active">Alerts <?php if ($alert_count > 0) { ?><span class="alert-badge"><?php echo $alert_count; ?></span><?php } ?></a>
        ...
        if (mysqli_num_rows($alerts) > 0) {
            while ($row = mysqli_fetch_assoc($alerts)) {
                ...
                echo "<div class='alert-item {$class}'>
                    ...
                    <a href='pharmacist_alerts.php?resolve={$row['id']}' class='resolve-btn'>Mark Resolved</a>
                </div>";
            }
        } else {
