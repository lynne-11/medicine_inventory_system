...
if ($_SESSION['user_role'] != 'pharmacist') {
    header("Location: login.php");
    exit();
}
include 'db.php';
...
$stock_out_today = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as count FROM stock_transactions WHERE type = 'stock_out' AND DATE(created_at) = CURDATE()"))['count'];
$total_medicines = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as count FROM medicines"))['count'];
$my_transactions = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) as count FROM stock_transactions WHERE user_id = {$_SESSION['user_id']}"))['count'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>PharmTrack - Pharmacist</title>
    <style>
...
<div class="sidebar" id="sidebar">
    ...
    <a href="pharmacist_dashboard.php" class="nav-item active">Dashboard</a>
    <a href="pharmacist_stock_out.php" class="nav-item">Record Stock Out</a>
    <a href="pharmacist_alerts.php" class="nav-item">
        Alerts
...
<div class="main">
    ...
    <div class="stats-grid">
        <div class="stat-card">
            ...
            <div class="value" style="color:#e74c3c;"><?php echo $stock_out_today; ?></div>
            <div class="sub">medicines issued</div>
        </div>
        <div class="stat-card">
        ...
        <div class="stat-card">
            <div class="label">My Total Transactions</div>
            <div class="value" style="color:#185FA5;"><?php echo $my_transactions; ?></div>
    ...
    <div class="quick-actions">
        <a href="pharmacist_stock_out.php" class="quick-btn">
    <div>
        <h4>Record Stock Out</h4>
        <p>Issue medicine to patient</p>
    </div>
</a>
<a href="pharmacist_reports.php" class="quick-btn">
    <div>
        <h4>View Reports</h4>
        <p>Monthly stock usage reports</p>
    </div>
</a>
    </div>
    ...
    <div class="two-col-grid">
        <div>
            <div class="section-header">
                <div class="section-title">My Recent Stock Out Transactions</div>
                <a href="pharmacist_stock_out.php" class="view-all">View all</a>
            </div>
            <div class="table-wrap">
                <table>
                    ...
                    $trans = mysqli_query($conn, "
                        ...
                        WHERE st.user_id = {$_SESSION['user_id']} AND st.type = 'stock_out'
        ...
        <div>
            <div class="section-header">
                ...
                <a href="pharmacist_alerts.php" class="view-all">View all</a>
            </div>
            <div class="table-wrap">
                <?php
    ...
    <!-- Medicines available for issue -->
    <div class="section-header">
        <div class="section-title">Medicines Available for Issue</div>
        <a href="pharmacist_stock_out.php" class="view-all">Record Stock Out</a>
    </div>
    <div class="table-wrap">
        <table>
            <thead>
